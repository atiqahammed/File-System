...
public class FileTreeFrame extends JFrame {
  ...
  private FileSystemModelBy fileSystemModel;
  private JTextArea fileDetailsTextArea = new JTextArea();
 
  public FileTreeFrame(String directory) {
    super("JTree FileSystem Viewer");
    fileDetailsTextArea.setEditable(false);
    fileSystemModel = new FileSystemModelBy(new File(directory));
...
class FileSystemModelBy implements TreeModel {
  private File root;
 
  private Vector listeners = new Vector();
 
  public FileSystemModelBy(File rootDirectory) {
    root = rootDirectory;
  }
